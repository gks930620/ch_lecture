# 프로젝트 구조 정리 (Security / OAuth2 로그인)

> 이 프로젝트의 기능은 **폼/OAuth2 로그인 · 회원가입 · 마이페이지 · 관리자 페이지**가 전부다.
> 아래는 이 프로젝트에 적용된 계층 구조 · DTO 분리 · Spring Security 설계 원칙이다.

- UI(HTML/CSS)는 Figma 디자인 시스템 기준: https://www.figma.com/community/file/1380235722331273046/simple-design-system
