...
public class 스트림2요소조건만족메인 {
    public static void main(String[] args) {
        ...
        boolean all10초과 = list.stream().allMatch(person -> person.age > 10);
        System.out.println("모두 10살 초과 : " +all10초과);
        boolean 한명은20초과=list.stream().anyMatch(person -> person.age > 20);  //최소한 하나라도 만족하나?
        System.out.println("한명은 20살 초과 : " +한명은20초과);
